...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        radioButton->setGeometry(QRect(140, 220, 91, 18));
        radioButton_2 = new QRadioButton(Widget);
        radioButton_2->setObjectName(QString::fromUtf8("radioButton_2"));
        radioButton_2->setGeometry(QRect(140, 280, 91, 18));
        label = new QLabel(Widget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(290, 220, 121, 16));
        label_2 = new QLabel(Widget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(290, 280, 111, 16));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label_2->setText(QCoreApplication::translate("Widget", "TextLabel &B", nullptr));
    } // retranslateUi
